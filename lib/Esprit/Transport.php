...
abstract class Transport extends \Esprit\Base {
	...
	public function __construct(array $config = null,\Esprit\Factory $factory = null) {
		...
		if (isset($factory)) {
			...
			$this->_factory = new \Esprit\Factory() ;
		}
	}
