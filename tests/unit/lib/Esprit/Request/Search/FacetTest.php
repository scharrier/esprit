...
class FacetTest extends \PHPUnit_Framework_TestCase {
	...
	public function testBase() {
		$facet = new \Esprit\Request\Search\Facet('category_id') ;
	...
	public function testIn() {
		...
		$facet = new \Esprit\Request\Search\Facet(array('in' => 'category_id')) ;
		$res = $facet->to('array') ;
		$expected = array(
			'category_id' => array(
				'terms' => array(
		...
		$facet = new \Esprit\Request\Search\Facet(array('field' => 'category_id')) ;
		$res = $facet->to('array') ;
		$expected = array(
			'category_id' => array(
				'terms' => array(
		...
		$facet = new \Esprit\Request\Search\Facet(array('name' => 'test_value_field','value_field' => 'category_id')) ;
		$res = $facet->to('array') ;
		$expected = array(
	...
	public function testMultipleFields() {
		$facet = new \Esprit\Request\Search\Facet(array('name' => 'category', 'fields' => array('Offers.category_id','Users.category_id'))) ;
		$res = $facet->to('array') ;
		$expected = array(
			'category' => array(
				'terms' => array(
	...
	public function testFluid() {
		$facet = new \Esprit\Request\Search\Facet('category') ;
